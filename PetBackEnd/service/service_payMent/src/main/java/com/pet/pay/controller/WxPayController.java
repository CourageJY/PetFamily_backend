...
import com.pet.pay.util.HttpUtils;
import com.pet.pay.util.WechatPay2ValidatorForRequest;
...
public class WxPayController {
    ...
    /**
     * Native下单
     * @param orderGenerate 包括petId、用户Id、订单目的地
     * @return 返回二维码链接和订单号
     * @throws Exception
     */
    @ApiOperation("调用统一下单API，生成支付二维码")
    @PostMapping("/native")
    public R nativePay(OrderGenerate orderGenerate) throws Exception {

        log.info("发起支付请求 v3");

        //返回支付二维码连接和订单号
        Map<String, Object> map = wxPayService.nativePay(orderGenerate);
